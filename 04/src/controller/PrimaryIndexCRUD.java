...
public class PrimaryIndexCRUD<T extends Registro, T2 extends RegistroHashExtensivel<T2>> {
    ...
    public PrimaryIndexCRUD(Constructor<T> construtor, Constructor<T2> construtorIndexWithoutParams,
        ...
        String filePath = String.format("%s%s.db", file, construtor.getName());
        String hashD_Path = String.format("%sdireto.%s.hash_d.db", file, construtor.getName());
        String hashC_Path = String.format("%sdireto.%s.hash_c.db", file, construtor.getName());
