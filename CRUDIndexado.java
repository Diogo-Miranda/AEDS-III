...
public class CRUDIndexado<T extends Registro, T2 extends RegistroHashExtensivel<T2>> {
    ...
    public CRUDIndexado(Constructor<T> construtor, 
                        Constructor<T2> construtorIndexWithoutParams, 
                        Constructor<T2> construtorIndexWithParams, 
                        String file) throws Exception, FileNotFoundException, IOException{
        ...
        he = new HashExtensivel<>(this.construtorIndexWithoutParams, 4, "dados/comentarios.hash_d.db", "dados/comentarios.hash_c.db");
    ...
    public int create(T objeto) throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, Exception {
        arq.seek(0);
        ...
        // Salvar o par id/endereço no arquivo de índice
        he.create(construtorIndexWithParams.newInstance(objID, posRegistro));
        he.print(); 

        return objID;
    }

    public T read(int ID) throws Exception, IOException, InstantiationException, IllegalAccessException, InvocationTargetException {
        T objeto = null;
        ...
        try{
            ...
            arq.seek(objetoHash.getEndereco());
    ...
    public boolean delete(int ID) throws Exception, IOException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException{        
    ...
    public boolean update(T objeto) throws Exception, IOException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException{
        T tempObjeto;
        boolean success = true;
        
        // Buscar no índice
        T2 objetoHash = he.read(objeto.getID()); 
        long posObjeto = objetoHash.getEndereco();
        arq.seek(posObjeto);
