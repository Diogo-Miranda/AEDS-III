...
public class CRUD<T extends Registro> {
    ...
    public T read(int ID) throws IOException, InstantiationException, IllegalAccessException, InvocationTargetException {
        // Pular "maxID"
        arq.seek(4);
        T objeto = null;
    ...
    public List<T> read() throws IOException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    public boolean update(T objeto) throws IOException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException{
        T tempObjeto;
