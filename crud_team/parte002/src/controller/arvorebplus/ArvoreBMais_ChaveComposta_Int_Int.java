 ...
 * disciplina:
 * - boolean create(int chave, int dado)   
 * - int[] read(int chave)
 * - boolean delete(int chave, int dado)
 * 
...
public class ArvoreBMais_ChaveComposta_Int_Int {
    ...
    public ArvoreBMais_ChaveComposta_Int_Int(int o, String na) throws IOException {
    ...
    private int[] read1(int chave1, long pagina) throws IOException {
    ...
    private boolean delete1(int chave1, int chave2, long pagina) throws IOException {
    ...
    private void print1(long pagina) throws IOException {
        ...
        for (i = 0; i < maxElementos; i++) {
            System.out.print("(" + String.format("%04d", pa.filhos[i]) + ") " + String.format("%2d", pa.chaves1[i])
                    + "," + String.format("%2d", pa.chaves2[i]) + " ");
        }
